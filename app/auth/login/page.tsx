  ...
  return (
    <div className="app-container">
      <div className="onboarding-screen">
        ...
        <h1 className="text-xl font-bold text-[#d2a24c] text-center mt-4">LOGIN NOW</h1>
        ...
        <div className="auth-form">
          ...
          <div className="text-right">
            <Link href="#" className="text-xs text-heritage-primary">
              Forgot password?
            </Link>
          </div>
          ...
          <Button
            ...
            className="bg-[#6f5643] hover:bg-[#5f4633] text-white w-full mt-4"
          >
            LOGIN
          </Button>
          ...
          <div className="text-center text-xs text-heritage-primary mt-2">
            ...
            <Link href="/auth/create-account" className="text-[#d2a24c]">
              Create account
            </Link>
          </div>
        </div>
